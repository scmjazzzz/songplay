...
export function Form({ children, sx, className, footer, mode, ...props }: React.PropsWithChildren<Props>) {
  return (
    <Box as="form" sx={sx} className={classNames(className, form({ mode }))} {...props}>
